...
class ProductosActivity : AppCompatActivity() {
    ...
    lateinit var adaptador: AdaptadorPrductos
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        if(tipo.equals("cold") ){
            adaptador = AdaptadorPrductos(this, coldDrinks, R.drawable.colddrinks)

        }

        if(tipo.equals("hot") ){
            adaptador = AdaptadorPrductos(this, hotDrinks, R.drawable.hotdrinks)

        }

        if(tipo.equals("sweets") ){
            adaptador = AdaptadorPrductos(this, sweets, R.drawable.sweets)

        }

        if(tipo.equals("salties") ){
            adaptador = AdaptadorPrductos(this, salties, R.drawable.salties)
    ...
    public class AdaptadorPrductos:BaseAdapter{
        var productos = ArrayList<Product>()
        var contexto: Context? = null
        var idImagen: Int

        constructor(contexto: Context, productos: ArrayList<Product>, idImagen: Int){
        ...
        override fun getView(position: Int, convertView: View?, parent: ViewGroup?): View {
            ...
            var descripcion = vista.findViewById(R.id.pruducto_descripcion) as TextView
            var precio = vista.findViewById(R.id.pruducto_precio) as TextView


            imagen.setImageResource(prod.image)
            nombre.setText(prod.name)
            descripcion.setText(prod.description)
            precio.setText(prod.price.toString())
